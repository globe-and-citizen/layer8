...
func (m *MockServiceInterface) GenerateAccessToken(clientID, clientSecret string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateAccessToken", clientID, clientSecret)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockServiceInterfaceMockRecorder) GenerateAccessToken(clientID, clientSecret any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateAccessToken", reflect.TypeOf((*MockServiceInterface)(nil).GenerateAccessToken), clientID, clientSecret)
}
...
func (mr *MockServiceInterfaceMockRecorder) GenerateAuthorizationURL(config, userID, headerMap any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockServiceInterface) VerifyAuthorizationCode(code string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "VerifyAuthorizationCode", code)
	ret0, _ := ret[0].(error)
	return ret0
}

// VerifyAuthorizationCode indicates an expected call of VerifyAuthorizationCode.
func (mr *MockServiceInterfaceMockRecorder) VerifyAuthorizationCode(code any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "VerifyAuthorizationCode", reflect.TypeOf((*MockServiceInterface)(nil).VerifyAuthorizationCode), code)
}
