...
// BulkAddBillToContract is a paid mutator transaction binding the contract method 0x9a72acb8.
//
// Solidity: function bulkAddBillToContract(uint64 timestamp, (bytes32,uint64)[] billings) returns()
func (_PayAsYouGo *PayAsYouGoTransactor) BulkAddBillToContract(opts *bind.TransactOpts, timestamp uint64, billings []PayAsYouGoBillingInput) (*types.Transaction, error) {
	return _PayAsYouGo.contract.Transact(opts, "bulkAddBillToContract", timestamp, billings)
}

// BulkAddBillToContract is a paid mutator transaction binding the contract method 0x9a72acb8.
//
// Solidity: function bulkAddBillToContract(uint64 timestamp, (bytes32,uint64)[] billings) returns()
func (_PayAsYouGo *PayAsYouGoSession) BulkAddBillToContract(timestamp uint64, billings []PayAsYouGoBillingInput) (*types.Transaction, error) {
	return _PayAsYouGo.Contract.BulkAddBillToContract(&_PayAsYouGo.TransactOpts, timestamp, billings)
}

// BulkAddBillToContract is a paid mutator transaction binding the contract method 0x9a72acb8.
//
// Solidity: function bulkAddBillToContract(uint64 timestamp, (bytes32,uint64)[] billings) returns()
func (_PayAsYouGo *PayAsYouGoTransactorSession) BulkAddBillToContract(timestamp uint64, billings []PayAsYouGoBillingInput) (*types.Transaction, error) {
	return _PayAsYouGo.Contract.BulkAddBillToContract(&_PayAsYouGo.TransactOpts, timestamp, billings)
}
