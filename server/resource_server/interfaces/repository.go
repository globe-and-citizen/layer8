...
type IRepository interface {
	...
	OnEmailVerified(userID uint, verificationCode string) error
	SaveVerificationData(data models.EmailVerificationData) error
	GetAndDeleteVerificationData(userId uint) (models.EmailVerificationData, error)
