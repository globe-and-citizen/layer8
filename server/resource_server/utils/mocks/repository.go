...
func NewMockRepository() interfaces.IRepository {
...
func (r *MockRepository) RegisterUser(req dto.RegisterUserDTO, hashedPassword string, salt string) error {
...
func (r *MockRepository) RegisterClient(client models.Client) error {
...
func (r *MockRepository) getUserData(userId uint) (map[string]string, error) {
...
func (r *MockRepository) FindUser(userId uint) (models.User, error) {
...
func (r *MockRepository) GetClientData(clientName string) (models.Client, error) {
...
func (r *MockRepository) LoginPreCheckUser(req dto.LoginPrecheckDTO) (string, string, error) {
...
func (r *MockRepository) LoginUser(req dto.LoginUserDTO) (models.User, error) {
	key := fmt.Sprintf("%s:%s", req.Username, req.Password)
...
func (r *MockRepository) LoginClient(req dto.LoginClientDTO) (models.Client, error) {
...
func (r *MockRepository) ProfileUser(userID uint) (models.User, []models.UserMetadata, error) {
...
func (r *MockRepository) ProfileClient(username string) (models.Client, error) {
...
func (r *MockRepository) SaveProofOfEmailVerification(
...
func (r *MockRepository) SaveEmailVerificationData(data models.EmailVerificationData) error {
	r.verificationDataStorage[strconv.Itoa(int(data.UserId))] = data
	return nil
}

func (r *MockRepository) GetEmailVerificationData(userId uint) (models.EmailVerificationData, error) {
...
func (r *MockRepository) UpdateDisplayName(userID uint, req dto.UpdateDisplayNameDTO) error {
	if _, ok := r.storage[fmt.Sprintf("%d", userID)]; !ok {
...
// Oauth methods
func (r *MockRepository) LoginUserPrecheck(username string) (string, error) {
	if _, ok := r.storage[username]; !ok {
...
func (r *MockRepository) LoginPreCheckClient(req dto.LoginPrecheckDTO) (string, string, error) {

	return "r.storage[username]['salt']", "second string...", nil
}

func (r *MockRepository) GetUser(username string) (*serverModels.User, error) {
	if _, ok := r.storage[username]; !ok {
...
func (r *MockRepository) GetUserByID(id int64) (*serverModels.User, error) {
...
func (r *MockRepository) GetUserMetadata(userID int64, key string) (*serverModels.UserMetadata, error) {
	if _, ok := r.storage[fmt.Sprintf("%d", userID)]; !ok {
...
func (r *MockRepository) SetClient(client *serverModels.Client) error {
...
func (r *MockRepository) GetClient(id string) (*serverModels.Client, error) {
...
func (r *MockRepository) GetClientDataByBackendURL(backendUrl string) (models.Client, error) {
...
func (r *MockRepository) SetTTL(key string, value []byte, ttl time.Duration) error {
...
func (r *MockRepository) GetTTL(key string) ([]byte, error) {
...
func (r *MockRepository) IsBackendURIExists(backendURL string) (bool, error) {
	for _, data := range r.storage {
		backend, ok := data["backend_uri"]
		if ok && backend == backendURL {
			return true, nil
...
func (r *MockRepository) SaveZkSnarksKeyPair(keyPair models.ZkSnarksKeyPair) (uint, error) {
	return 0, nil
}

func (r *MockRepository) GetLatestZkSnarksKeys() (models.ZkSnarksKeyPair, error) {
	return models.ZkSnarksKeyPair{}, nil
}

func (r *MockRepository) GetUserForUsername(username string) (models.User, error) {
	return models.User{}, nil
}

func (r *MockRepository) UpdateUserPassword(username string, password string) error {
	return nil
}

func (r *MockRepository) RegisterUserv2(dto dto.RegisterUserDTOv2) error {
	return nil
}

func (r *MockRepository) RegisterPrecheckUser(req dto.RegisterUserPrecheckDTO, salt string, iterCount int) error {
